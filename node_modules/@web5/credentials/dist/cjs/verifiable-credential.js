        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                vcDataModel = __assign(__assign(__assign(__assign({ '@context': contexts, type: Array.isArray(type)
                        ? __spreadArray([exports.DEFAULT_VC_TYPE], type, true) : (type ? [exports.DEFAULT_VC_TYPE, type] : [exports.DEFAULT_VC_TYPE]), id: "urn:uuid:".concat(crypto_1.utils.randomUuid()), issuer: issuer, issuanceDate: issuanceDate || (0, utils_js_1.getCurrentXmlSchema112Timestamp)(), credentialSubject: credentialSubject }, (expirationDate && { expirationDate: expirationDate })), (credentialStatus && { credentialStatus: credentialStatus })), (credentialSchema && { credentialSchema: credentialSchema })), (evidence && { evidence: evidence }));
