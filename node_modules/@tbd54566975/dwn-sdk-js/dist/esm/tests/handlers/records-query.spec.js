    ...
    describe('RecordsQueryHandler.handle()', () => {
        describe('functional tests', () => {
            ...
            it('should be able to query for published records', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect((_o = publishedPostReply.entries) === null || _o === void 0 ? void 0 : _o.length).to.equal(1);
                ...
                expect((_p = notOwnerPublishedPostReply.entries) === null || _p === void 0 ? void 0 : _p.length).to.equal(1);
                ...
                expect((_q = anonymousPublishedPostReply.entries) === null || _q === void 0 ? void 0 : _q.length).to.equal(1);
                ...
                expect(publishedPostReply.status.code).to.equal(200);
                expect((_r = publishedPostReply.entries) === null || _r === void 0 ? void 0 : _r.length).to.equal(2);
                const returnedRecordIds = (_s = publishedPostReply.entries) === null || _s === void 0 ? void 0 : _s.map(e => e.recordId);
                ...
                expect(notOwnerPublishedPostReply.status.code).to.equal(200);
                expect((_t = notOwnerPublishedPostReply.entries) === null || _t === void 0 ? void 0 : _t.length).to.equal(2);
                const nonOwnerReturnedRecordIds = (_u = notOwnerPublishedPostReply.entries) === null || _u === void 0 ? void 0 : _u.map(e => e.recordId);
                ...
                expect(anonymousPublishedPostReply.status.code).to.equal(200);
                expect((_v = anonymousPublishedPostReply.entries) === null || _v === void 0 ? void 0 : _v.length).to.equal(2);
                const anonymousReturnedRecordIds = (_w = anonymousPublishedPostReply.entries) === null || _w === void 0 ? void 0 : _w.map(e => e.recordId);
            ...
            it('should be able to query for unpublished records', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect((_x = unpublishedPostReply.entries) === null || _x === void 0 ? void 0 : _x.length).to.equal(1);
                ...
                expect(unpublishedPostReply.status.code).to.equal(200);
                expect((_y = unpublishedPostReply.entries) === null || _y === void 0 ? void 0 : _y.length).to.equal(0);
            }));
            it('should not be able to query for unpublished records if unauthorized', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect((_z = notOwnerPostReply.entries) === null || _z === void 0 ? void 0 : _z.length).to.equal(0);
                // publish the unpublished record
                const publishedDraftWrite = yield RecordsWrite.createFrom({
                    recordsWriteMessage: draftWrite.message,
                    published: true,
                ...
                expect((_0 = publishedNotOwnerReply.entries) === null || _0 === void 0 ? void 0 : _0.length).to.equal(2);
                ...
                expect(publishedNotOwnerReply.status.code).to.equal(200);
                expect((_1 = publishedNotOwnerReply.entries) === null || _1 === void 0 ? void 0 : _1.length).to.equal(2);
                ...
                expect(notOwnerPostReply.status.code).to.equal(200);
                expect((_2 = notOwnerPostReply.entries) === null || _2 === void 0 ? void 0 : _2.length).to.equal(0);
            }));
            it('should be able to query for a record by a dataCid', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect((_3 = dataCidQueryReply.entries) === null || _3 === void 0 ? void 0 : _3.length).to.equal(1);
            ...
            it('should be able to query with `dataSize` filter (half-open range)', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const reply1 = yield dwn.processMessage(alice.did, recordsQuery1.message);
                expect((_4 = reply1.entries) === null || _4 === void 0 ? void 0 : _4.length).to.equal(2);
                expect((_5 = reply1.entries) === null || _5 === void 0 ? void 0 : _5.map((entry) => entry.encodedData)).to.have.members([
                ...
                const reply2 = yield dwn.processMessage(alice.did, recordsQuery2.message);
                expect((_6 = reply2.entries) === null || _6 === void 0 ? void 0 : _6.length).to.equal(2);
                expect((_7 = reply2.entries) === null || _7 === void 0 ? void 0 : _7.map((entry) => entry.encodedData)).to.have.members([
                ...
                const reply3 = yield dwn.processMessage(alice.did, recordsQuery3.message);
                expect((_8 = reply3.entries) === null || _8 === void 0 ? void 0 : _8.length).to.equal(3);
                expect((_9 = reply3.entries) === null || _9 === void 0 ? void 0 : _9.map((entry) => entry.encodedData)).to.have.members([
                    Encoder.bytesToBase64Url(write1.dataBytes),
                    Encoder.bytesToBase64Url(write2.dataBytes),
                    Encoder.bytesToBase64Url(write3.dataBytes)
                ]);
                ...
                expect((_10 = reply4.entries) === null || _10 === void 0 ? void 0 : _10.length).to.equal(3);
                expect((_11 = reply4.entries) === null || _11 === void 0 ? void 0 : _11.map((entry) => entry.encodedData)).to.have.members([
                    Encoder.bytesToBase64Url(write1.dataBytes),
                    Encoder.bytesToBase64Url(write2.dataBytes),
                    Encoder.bytesToBase64Url(write3.dataBytes)
                ]);
            ...
            it('should be able to range query with `dataSize` filter (open & closed range)', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const reply1 = yield dwn.processMessage(alice.did, recordsQuery1.message);
                expect((_12 = reply1.entries) === null || _12 === void 0 ? void 0 : _12.length).to.equal(1);
                ...
                const reply2RecordIds = (_14 = reply2.entries) === null || _14 === void 0 ? void 0 : _14.map(e => e.recordId);
                ...
                const reply3 = yield dwn.processMessage(alice.did, recordsQuery3.message);
                expect((_15 = reply3.entries) === null || _15 === void 0 ? void 0 : _15.length).to.equal(1);
                ...
                const reply4 = yield dwn.processMessage(alice.did, recordsQuery4.message);
                expect((_16 = reply4.entries) === null || _16 === void 0 ? void 0 : _16.length).to.equal(3);
                const reply4RecordIds = (_17 = reply4.entries) === null || _17 === void 0 ? void 0 : _17.map(e => e.recordId);
            ...
            it('should be able to range query by `dateCreated`', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const reply1 = yield dwn.processMessage(alice.did, recordsQuery1.message);
                expect((_18 = reply1.entries) === null || _18 === void 0 ? void 0 : _18.length).to.equal(2);
                ...
                const reply2 = yield dwn.processMessage(alice.did, recordsQuery2.message);
                expect((_19 = reply2.entries) === null || _19 === void 0 ? void 0 : _19.length).to.equal(2);
                ...
                const reply3 = yield dwn.processMessage(alice.did, recordsQuery3.message);
                expect((_20 = reply3.entries) === null || _20 === void 0 ? void 0 : _20.length).to.equal(1);
                ...
                const reply4 = yield dwn.processMessage(alice.did, recordsQuery4.message);
                expect((_21 = reply4.entries) === null || _21 === void 0 ? void 0 : _21.length).to.equal(1);
            ...
            it('should not return records that were published and then unpublished ', () => __awaiter(this, void 0, void 0, function* () {
                ...
                var _22, _23, _24, _25, _26, _27, _28, _29, _30, _31, _32, _33;
                ...
                expect((_22 = reply1.entries) === null || _22 === void 0 ? void 0 : _22.length).to.equal(2);
                const reply1RecordIds = (_23 = reply1.entries) === null || _23 === void 0 ? void 0 : _23.map(e => e.recordId);
                ...
                expect((_24 = ownerPublishedReply.entries) === null || _24 === void 0 ? void 0 : _24.length).to.equal(3);
                const ownerPublishedIds = (_25 = ownerPublishedReply.entries) === null || _25 === void 0 ? void 0 : _25.map(e => e.recordId);
                ...
                expect((_26 = anonymousRangeReply.entries) === null || _26 === void 0 ? void 0 : _26.length).to.equal(2);
                const anonymousReplyIds = (_27 = anonymousRangeReply.entries) === null || _27 === void 0 ? void 0 : _27.map(e => e.recordId);
                ...
                expect((_28 = anonymousPublishedReply.entries) === null || _28 === void 0 ? void 0 : _28.length).to.equal(3);
                const anonymousPublishedIds = (_29 = anonymousPublishedReply.entries) === null || _29 === void 0 ? void 0 : _29.map(e => e.recordId);
                ...
                expect(anonymousRangeReply.status.code).to.equal(200);
                expect((_30 = anonymousRangeReply.entries) === null || _30 === void 0 ? void 0 : _30.length).to.equal(0);
                ...
                expect(anonymousPublishedReply.status.code).to.equal(200);
                expect((_31 = anonymousPublishedReply.entries) === null || _31 === void 0 ? void 0 : _31.length).to.equal(0);
                ...
                expect((_32 = ownerRangeReply.entries) === null || _32 === void 0 ? void 0 : _32.length).to.equal(0);
                ...
                expect(ownerPublishedReply.status.code).to.equal(200);
                expect((_33 = ownerPublishedReply.entries) === null || _33 === void 0 ? void 0 : _33.length).to.equal(0);
            }));
            it('should be able to range query by `datePublished`', () => __awaiter(this, void 0, void 0, function* () {
                ...
                var _34, _35, _36, _37, _38, _39, _40, _41, _42, _43;
                const firstDayOf2020 = Time.createTimestamp({ year: 2020, month: 1, day: 1 });
                const firstDayOf2021 = Time.createTimestamp({ year: 2021, month: 1, day: 1 });
                const firstDayOf2022 = Time.createTimestamp({ year: 2022, month: 1, day: 1 });
                const firstDayOf2023 = Time.createTimestamp({ year: 2023, month: 1, day: 1 });
                ...
                const reply1 = yield dwn.processMessage(alice.did, recordsQuery1.message);
                expect((_34 = reply1.entries) === null || _34 === void 0 ? void 0 : _34.length).to.equal(2);
                const reply1RecordIds = (_35 = reply1.entries) === null || _35 === void 0 ? void 0 : _35.map(e => e.recordId);
                expect(reply1RecordIds).to.have.members([write2.message.recordId, write3.message.recordId]);
                // testing `to` range
                const lastDayOf2022 = Time.createTimestamp({ year: 2022, month: 12, day: 31 });
                const recordsQuery2 = yield TestDataGenerator.generateRecordsQuery({
                ...
                const reply2 = yield dwn.processMessage(alice.did, recordsQuery2.message);
                expect((_36 = reply2.entries) === null || _36 === void 0 ? void 0 : _36.length).to.equal(2);
                const reply2RecordIds = (_37 = reply2.entries) === null || _37 === void 0 ? void 0 : _37.map(e => e.recordId);
                expect(reply2RecordIds).to.have.members([write1.message.recordId, write2.message.recordId]);
                // testing `from` and `to` range
                const lastDayOf2023 = Time.createTimestamp({ year: 2023, month: 12, day: 31 });
                const recordsQuery3 = yield TestDataGenerator.generateRecordsQuery({
                ...
                const reply3 = yield dwn.processMessage(alice.did, recordsQuery3.message);
                expect((_38 = reply3.entries) === null || _38 === void 0 ? void 0 : _38.length).to.equal(1);
                expect(reply3.entries[0].recordId).to.equal(write3.message.recordId);
                // testing edge case where value equals `from` and `to`
                const recordsQuery4 = yield TestDataGenerator.generateRecordsQuery({
                    author: alice,
                ...
                const reply4 = yield dwn.processMessage(alice.did, recordsQuery4.message);
                expect((_39 = reply4.entries) === null || _39 === void 0 ? void 0 : _39.length).to.equal(1);
                ...
                expect((_40 = anonymousReply.entries) === null || _40 === void 0 ? void 0 : _40.length).to.equal(2);
                const anonymousReplyIds = (_41 = anonymousReply.entries) === null || _41 === void 0 ? void 0 : _41.map(e => e.recordId);
                expect(anonymousReplyIds).to.have.members([write2.message.recordId, write3.message.recordId]);
                ...
                expect((_42 = nonOwnerReply.entries) === null || _42 === void 0 ? void 0 : _42.length).to.equal(2);
                const nonOwnerReplyIds = (_43 = nonOwnerReply.entries) === null || _43 === void 0 ? void 0 : _43.map(e => e.recordId);
            ...
            it('should be able to range query by `dateUpdated`', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const reply1 = yield dwn.processMessage(alice.did, recordsQuery1.message);
                expect((_44 = reply1.entries) === null || _44 === void 0 ? void 0 : _44.length).to.equal(2);
                const reply1RecordIds = (_45 = reply1.entries) === null || _45 === void 0 ? void 0 : _45.map(e => e.recordId);
                expect(reply1RecordIds).to.have.members([write2.message.recordId, write3.message.recordId]);
                // testing `to` range
                const lastDayOf2022 = Time.createTimestamp({ year: 2022, month: 12, day: 31 });
                const recordsQuery2 = yield TestDataGenerator.generateRecordsQuery({
                ...
                const reply2 = yield dwn.processMessage(alice.did, recordsQuery2.message);
                expect((_46 = reply2.entries) === null || _46 === void 0 ? void 0 : _46.length).to.equal(2);
                const reply2RecordIds = (_47 = reply2.entries) === null || _47 === void 0 ? void 0 : _47.map(e => e.recordId);
                expect(reply2RecordIds).to.have.members([write1.message.recordId, write2.message.recordId]);
                // testing `from` and `to` range
                const lastDayOf2023 = Time.createTimestamp({ year: 2023, month: 12, day: 31 });
                const recordsQuery3 = yield TestDataGenerator.generateRecordsQuery({
                ...
                const reply3 = yield dwn.processMessage(alice.did, recordsQuery3.message);
                expect((_48 = reply3.entries) === null || _48 === void 0 ? void 0 : _48.length).to.equal(1);
                expect(reply3.entries[0].recordId).to.equal(write3.message.recordId);
                // testing edge case where value equals `from` and `to`
                const recordsQuery4 = yield TestDataGenerator.generateRecordsQuery({
                    author: alice,
                ...
                const reply4 = yield dwn.processMessage(alice.did, recordsQuery4.message);
                expect((_49 = reply4.entries) === null || _49 === void 0 ? void 0 : _49.length).to.equal(1);
                expect(reply4.entries[0].recordId).to.equal(write2.message.recordId);
            }));
            it('should be able use range and exact match queries at the same time', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect((_50 = reply.entries) === null || _50 === void 0 ? void 0 : _50.length).to.equal(1);
            ...
            it('should include `authorization` in returned records', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect(queryReply.status.code).to.equal(200);
                expect((_51 = queryReply.entries) === null || _51 === void 0 ? void 0 : _51.length).to.equal(1);
            ...
            it('should include `attestation` in returned records', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const queryReply = yield dwn.processMessage(alice.did, queryData.message);
                expect(queryReply.status.code).to.equal(200);
                expect((_52 = queryReply.entries) === null || _52 === void 0 ? void 0 : _52.length).to.equal(1);
                const recordsWriteMessage = queryReply.entries[0];
                expect((_54 = (_53 = recordsWriteMessage.attestation) === null || _53 === void 0 ? void 0 : _53.signatures) === null || _54 === void 0 ? void 0 : _54.length).to.equal(1);
            }));
            it('should omit records that are not published if `dateSort` sorts on `datePublished`', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect((_55 = publishedAscendingQueryReply.entries) === null || _55 === void 0 ? void 0 : _55.length).to.equal(1);
                ...
                expect((_56 = publishedDescendingQueryReply.entries) === null || _56 === void 0 ? void 0 : _56.length).to.equal(1);
            ...
            it('should sort records if `dateSort` is specified with and without a cursor', () => __awaiter(this, void 0, void 0, function* () {
                var _57, _58, _59, _60, _61, _62, _63, _64, _65, _66, _67, _68;
                ...
                expect((_57 = createdAscendingQueryReply.entries) === null || _57 === void 0 ? void 0 : _57[0].recordId).to.equal(write1Data.message.recordId);
                expect((_58 = createdAscendingQueryReply.entries) === null || _58 === void 0 ? void 0 : _58[1].recordId).to.equal(write2Data.message.recordId);
                expect((_59 = createdAscendingQueryReply.entries) === null || _59 === void 0 ? void 0 : _59[2].recordId).to.equal(write3Data.message.recordId);
                ...
                expect((_60 = createdDescendingQueryReply.entries) === null || _60 === void 0 ? void 0 : _60[0].recordId).to.equal(write3Data.message.recordId);
                expect((_61 = createdDescendingQueryReply.entries) === null || _61 === void 0 ? void 0 : _61[1].recordId).to.equal(write2Data.message.recordId);
                expect((_62 = createdDescendingQueryReply.entries) === null || _62 === void 0 ? void 0 : _62[2].recordId).to.equal(write1Data.message.recordId);
                // to test with a cursor we first get a single record
                ...
                expect((_63 = publishedAscendingQueryReply.entries) === null || _63 === void 0 ? void 0 : _63[0].recordId).to.equal(write1Data.message.recordId);
                expect((_64 = publishedAscendingQueryReply.entries) === null || _64 === void 0 ? void 0 : _64[1].recordId).to.equal(write2Data.message.recordId);
                expect((_65 = publishedAscendingQueryReply.entries) === null || _65 === void 0 ? void 0 : _65[2].recordId).to.equal(write3Data.message.recordId);
                // to test with a cursor we first get a single record
                ...
                expect((_66 = publishedDescendingQueryReply.entries) === null || _66 === void 0 ? void 0 : _66[0].recordId).to.equal(write3Data.message.recordId);
                expect((_67 = publishedDescendingQueryReply.entries) === null || _67 === void 0 ? void 0 : _67[1].recordId).to.equal(write2Data.message.recordId);
                expect((_68 = publishedDescendingQueryReply.entries) === null || _68 === void 0 ? void 0 : _68[2].recordId).to.equal(write1Data.message.recordId);
            ...
            it('should tiebreak using `messageCid` when sorting encounters identical values', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect(queryReply.status.code).to.equal(200);
                expect((_69 = queryReply.entries) === null || _69 === void 0 ? void 0 : _69.length).to.equal(3);
            ...
            it('should paginate all records in ascending order', () => __awaiter(this, void 0, void 0, function* () {
                ...
                while (true) {
                    ...
                    expect((_70 = pageReply.entries) === null || _70 === void 0 ? void 0 : _70.length).to.be.lte(limit);
            ...
            it('should paginate all records in descending order', () => __awaiter(this, void 0, void 0, function* () {
                ...
                while (true) {
                    ...
                    expect(pageReply.status.code).to.equal(200);
                    cursor = pageReply.cursor;
                    expect((_71 = pageReply.entries) === null || _71 === void 0 ? void 0 : _71.length).to.be.lte(limit);
                    results.push(...pageReply.entries);
                    if (cursor === undefined) {
                        break;
                    }
            ...
            it('should allow an anonymous unauthenticated query to return published records', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect((_72 = replyToQuery.entries) === null || _72 === void 0 ? void 0 : _72.length).to.equal(1);
                ...
                expect((_73 = publishedReply.entries) === null || _73 === void 0 ? void 0 : _73.length).to.equal(1);
            ...
            it('should only return published records and unpublished records that is meant for author', () => __awaiter(this, void 0, void 0, function* () {
                ...
                var _74, _75, _76, _77, _78, _79, _80, _81, _82;
                const alice = yield TestDataGenerator.generateDidKeyPersona();
                const bob = yield TestDataGenerator.generateDidKeyPersona();
                const carol = yield TestDataGenerator.generateDidKeyPersona();
                ...
                const additionalIndexes1 = yield record1Data.recordsWrite.constructIndexes(true);
                record1Data.message = yield recordsWriteHandler.cloneAndAddEncodedData(record1Data.message, record1Data.dataBytes);
                yield messageStore.put(alice.did, record1Data.message, additionalIndexes1);
                yield eventLog.append(alice.did, yield Message.getCid(record1Data.message), additionalIndexes1);
                const additionalIndexes2 = yield record2Data.recordsWrite.constructIndexes(true);
                record2Data.message = yield recordsWriteHandler.cloneAndAddEncodedData(record2Data.message, record2Data.dataBytes);
                yield messageStore.put(alice.did, record2Data.message, additionalIndexes2);
                yield eventLog.append(alice.did, yield Message.getCid(record2Data.message), additionalIndexes1);
                const additionalIndexes3 = yield record3Data.recordsWrite.constructIndexes(true);
                record3Data.message = yield recordsWriteHandler.cloneAndAddEncodedData(record3Data.message, record3Data.dataBytes);
                yield messageStore.put(alice.did, record3Data.message, additionalIndexes3);
                yield eventLog.append(alice.did, yield Message.getCid(record3Data.message), additionalIndexes1);
                const additionalIndexes4 = yield record4Data.recordsWrite.constructIndexes(true);
                record4Data.message = yield recordsWriteHandler.cloneAndAddEncodedData(record4Data.message, record4Data.dataBytes);
                yield messageStore.put(alice.did, record4Data.message, additionalIndexes4);
                yield eventLog.append(alice.did, yield Message.getCid(record4Data.message), additionalIndexes1);
                const additionalIndexes5 = yield record5Data.recordsWrite.constructIndexes(true);
                record5Data.message = yield recordsWriteHandler.cloneAndAddEncodedData(record5Data.message, record5Data.dataBytes);
                yield messageStore.put(alice.did, record5Data.message, additionalIndexes5);
                yield eventLog.append(alice.did, yield Message.getCid(record5Data.message), additionalIndexes1);
                ...
                expect((_74 = replyToBob.entries) === null || _74 === void 0 ? void 0 : _74.length).to.equal(4); // expect 4 records
                const privateRecordsForBob = (_75 = replyToBob.entries) === null || _75 === void 0 ? void 0 : _75.filter(message => message.encodedData === Encoder.stringToBase64Url('2'));
                const privateRecordsFromBob = (_76 = replyToBob.entries) === null || _76 === void 0 ? void 0 : _76.filter(message => message.encodedData === Encoder.stringToBase64Url('3'));
                const publicRecords = (_77 = replyToBob.entries) === null || _77 === void 0 ? void 0 : _77.filter(message => message.encodedData === Encoder.stringToBase64Url('4') || message.encodedData === Encoder.stringToBase64Url('5'));
                ...
                expect((_78 = unpublishedBobReply.entries) === null || _78 === void 0 ? void 0 : _78.length).to.equal(2);
                const unpublishedBobRecordIds = (_79 = unpublishedBobReply.entries) === null || _79 === void 0 ? void 0 : _79.map(e => e.recordId);
                ...
                expect((_80 = replyToAliceQuery.entries) === null || _80 === void 0 ? void 0 : _80.length).to.equal(5); // expect all 5 records
                ...
                expect((_81 = replyToBobCarolQuery.entries) === null || _81 === void 0 ? void 0 : _81.length).to.equal(1);
                ...
                expect((_82 = replyToBobCarolUnpublishedQuery.entries) === null || _82 === void 0 ? void 0 : _82.length).to.equal(0);
            }));
            it('should paginate correctly for fetchRecordsAsNonOwner()', () => __awaiter(this, void 0, void 0, function* () {
                var _83, e_1, _84, _85;
                var _86, _87, _88, _89, _90;
                const alice = yield TestDataGenerator.generateDidKeyPersona();
                const bob = yield TestDataGenerator.generateDidKeyPersona();
                const schema = 'schema1';
                ...
                const messages = [];
                try {
                    for (var _91 = true, messagePromises_1 = __asyncValues(messagePromises), messagePromises_1_1; messagePromises_1_1 = yield messagePromises_1.next(), _83 = messagePromises_1_1.done, !_83; _91 = true) {
                        _85 = messagePromises_1_1.value;
                        _91 = false;
                        const { recordsWrite, message, dataBytes } = _85;
                    ...
                    try {
                        if (!_91 && !_83 && (_84 = messagePromises_1.return)) yield _84.call(messagePromises_1);
                    }
                ...
                expect((_86 = results.entries) === null || _86 === void 0 ? void 0 : _86.length).to.equal(10, 'alice page 1');
                ...
                expect(results.status.code).to.equal(200);
                expect((_87 = results.entries) === null || _87 === void 0 ? void 0 : _87.length).to.equal(10, 'alice page 2');
                ...
                expect(results.status.code).to.equal(200);
                expect((_88 = results.entries) === null || _88 === void 0 ? void 0 : _88.length).to.equal(5, 'alice page 3');
                ...
                expect(results.status.code).to.equal(200);
                expect((_89 = results.entries) === null || _89 === void 0 ? void 0 : _89.length).to.equal(10, 'bob page 1');
                ...
                expect(results.status.code).to.equal(200);
                expect((_90 = results.entries) === null || _90 === void 0 ? void 0 : _90.length).to.equal(10, 'bob page 2');
            ...
            it('#170 - should treat records with `published` explicitly set to `false` as unpublished', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect(replyToAliceQuery.status.code).to.equal(200);
                expect((_92 = replyToAliceQuery.entries) === null || _92 === void 0 ? void 0 : _92.length).to.equal(1);
                ...
                expect((_93 = replyToBobQuery.entries) === null || _93 === void 0 ? void 0 : _93.length).to.equal(0);
            }));
            ...
            it('should not fetch entries across tenants', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect(reply.status.code).to.equal(200);
                expect((_94 = reply.entries) === null || _94 === void 0 ? void 0 : _94.length).to.equal(1);
            }));
            ...
            it('should return 401 for anonymous queries that filter explicitly for unpublished records', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect(unpublishedPostReply.status.code).to.equal(200);
                expect((_95 = unpublishedPostReply.entries) === null || _95 === void 0 ? void 0 : _95.length).to.equal(1);
                expect(unpublishedPostReply.entries[0].recordId).to.equal(draftWrite.message.recordId);
